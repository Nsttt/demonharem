...
window.javascriptLocales = {
  copyMessage:
    "HAHAHA FOOL, THE POWER OF THIS WEBPAGE EVEN REACHES YOUR CLIPBOARD AND CAN CONTROL IT AT WILL\n" +
...
document.getElementById("listen").addEventListener("click", () => {
  ...
  audio.addEventListener("ended", () => {
    ...
    if (audioPlayingAtOnce < 8) {
      document.getElementById("definition-name").innerText =
        javascriptLocales.paradise;
    }
  });
...
document
  .getElementById("close-language-protip")
